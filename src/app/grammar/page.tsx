      ...
      <div className="mx-auto flex w-full max-w-5xl gap-8 px-4 py-8 sm:px-8">
              ...
              <section key={group}>
                ...
                <div className="space-y-1">
                  {grammarTopics
                    ...
                    .map((topic) => (
                      <Link
                        className="block border-l-[3px] border-transparent py-1.5 pl-3 text-sm text-gray-700 hover:text-brand-600"
        ...
        <section className="w-full max-w-2xl">
          ...
          <header className="mb-6">
            <p className="text-sm font-medium text-brand-600">COURSE-002</p>
          ...
          <div className="flex flex-col gap-3">
            {grammarTopics.map((topic) => (
              <Link
                className="group rounded-xl shadow-sm border border-gray-100 bg-surface p-4 transition hover:border-brand-100"
                href={`/grammar/${topic.slug}`}
                key={topic.slug}
              >
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="shrink-0 text-xl text-gray-300 group-hover:text-brand-600">→</span>
                </div>
              </Link>
            ))}
          </div>
