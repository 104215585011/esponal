...
export function MobileTopBar({
  ...
  return (
    <div className="md:hidden sticky top-0 z-50 border-b border-zinc-200/50 bg-white/70 px-4 backdrop-blur-xl dark:border-zinc-800/50 dark:bg-zinc-950/70">
