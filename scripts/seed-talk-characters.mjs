...
const CHARACTERS = [
  {
    ...
    style:
      "Measured elegance, formal British English, literary warmth, and precise correction.",
...
async function main() {
  for (const character of CHARACTERS) {
    ...
    console.log(`✓ upserted character: ${character.id} (${character.name})`);
  }
  console.log(`\nSeeded ${CHARACTERS.length} talk characters.`);
}
