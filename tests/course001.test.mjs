...
test("COURSE-001 page renders the approved no-pressure layout", async () => {
  ...
  assert.match(page, /border-t/);
  assert.match(page, /flex/);
  assert.match(page, /rounded-/);
  assert.match(page, /font-bold/);
  assert.match(page, /text-xs/);
  assert.match(page, /text-base/);
  assert.match(page, /text-sm/);
  assert.match(page, /text-sm/);
